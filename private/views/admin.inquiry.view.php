                            ...
                            <div class="row mb-30 g-20">
                                <div class="col-3">
                                    <div class="text-inputs">
                                        <div class="input-text-label text lightgray-font">Category</div>
                            ...
                            <table class="">
                                ...
                                <tbody>
                                            ...
                                            <td class="col-1 d-flex align-items-center g-5">
                                                ...
                                                <a class="blue">
                                                    <div class="badge-base bg-Selected-green">
                                                        ...
                                                        <div class="text green">Resolve</div>
                                                    </div>
                                                </a>
                                                 <a class="blue">
                                        ...
                                        <tr class="row p-20">
                                            ...
                                            <td class="col-2 d-flex align-items-center">
                                                <div class="d-flex .flex-row g-5 mr-5">
                                                   Need to cancel the booking. But got and Error...
                                                </div>
                                            </td>
                                            <td class="col-1 d-flex align-items-center g-5">
                                                <a class="blue">
